...
import java.util.concurrent.{ConcurrentHashMap, ConcurrentLinkedQueue, Executors, ExecutorService, ScheduledExecutorService, TimeUnit}
...
private[spark] class ContextCleaner(sc: SparkContext) extends Logging {
  ...
  private def submitTask(ref: CleanupTaskWeakReference) = {
